  ...
  es: {
    ...
    terms: {
      ...
      sections: [
        ...
        { title: 'Compra sin anuncios', paragraphs: ['Cuando está disponible en tu versión, Palabravo sin anuncios es una compra única al precio mostrado por la tienda. Elimina todos los anuncios e incluye tres pistas por día UTC, no acumulables y con un máximo de dos por intento. El cupo se renueva a las 00:00 UTC. Estos beneficios se mantienen para quienes compraron y no incluyen automáticamente futuros packs de pago.', 'Puedes restaurar la compra dentro de la misma tienda. No se transfiere entre Android e iOS. Las solicitudes de devolución se tramitan con la tienda correspondiente y una devolución confirmada revoca el beneficio. Una compra pendiente solo se activa después de verificarse.'] },
  ...
  en: {
    ...
    terms: {
      ...
      sections: [
        ...
        { title: 'Remove ads purchase', paragraphs: ['When available in your version, Palabravo without ads is a one-time purchase at the price shown by the store. It removes every ad and includes three hints per UTC day, without rollover and with a maximum of two per attempt. The allowance resets at 00:00 UTC. These benefits are retained for purchasers and do not automatically include future paid packs.', 'Purchases can be restored within the same store and do not transfer between Android and iOS. Refunds are handled by the corresponding store; a confirmed refund revokes the benefit. Pending purchases are activated only after verification.'] },
